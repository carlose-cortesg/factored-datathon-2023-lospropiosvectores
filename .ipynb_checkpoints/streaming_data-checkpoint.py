...
def on_event(partition_context, event):
    ...
    data = {key:data[key] for key in ['asin','reviewText', 'summary','reviewerID','overall']}
    ...
    errors = client.insert_rows_json('factored.reviews_with_topics_streaming', [data_with_topics])
    if not errors:
        print("Data successfully uploaded to BigQuery.")
    else:
        print("Errors occurred while uploading data:")
